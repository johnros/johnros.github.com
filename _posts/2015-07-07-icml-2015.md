...
### Greed is Great
From the greedy optimization algorithms workshop I particularly liked [Aurelien Bellet's](http://perso.telecom-paristech.fr/~abellet/) presentation using the [Frank-Wolfe](https://en.wikipedia.org/wiki/Frank%E2%80%93Wolfe_algorithm) algorithm for similarity learning. 
